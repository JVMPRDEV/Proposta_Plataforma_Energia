  ...
  const docs = [
    ...
    },
    {
      ...
      itens: [
        ...
        { icon: '⚡', titulo: 'Protótipo Core',          desc: 'Apenas os módulos do Core (382h / R$ 28.500). Faturamento sem gateway, baixa manual e template do cliente.', href: '../prototipo-core/index.html', tag: 'SPA' }
      ]
    }
  ];
