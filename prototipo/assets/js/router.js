...
(function() {
  const routes = {
    ...
    '/cobranca':       { title: 'Cobrança / Asaas',         view: 'cobranca',      icon: 'card' },
    '/whatsapp':       { title: 'Comunicação WhatsApp',     view: 'whatsapp',      icon: 'chat' },
  ...
  const NAV_GROUPS = [
    ...
    { label: 'Financeiro', items: ['/faturamento', '/cobranca', '/relatorios'] },
    { label: 'Comunicação', items: ['/whatsapp'] },
